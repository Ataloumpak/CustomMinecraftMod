...
/**
 * Block d'exemple pour stocker des datas
 */
public class DataBlock extends Block implements ITileEntityProvider {
    ...
    public DataBlock() {
        super(Material.ROCK);
        setUnlocalizedName(ExampleMod.MODID + ".datablock");
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
        ...
        if (!world.isRemote) {
            ...
            if (side == state.getValue(FACING)) {
                ...
                TextComponentTranslation component = new TextComponentTranslation("message.examplemod.counter_par", counter);
